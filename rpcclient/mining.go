...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address string, maxTries *int64) FutureGenerateToAddressResult {
	cmd := btcjson.NewGenerateToAddressCmd(numBlocks, address, maxTries)
	return c.sendCmd(cmd)
}

// Generate generates numBlocks blocks to the given address and returns their hashes.
func (c *Client) GenerateToAddress(numBlocks int64, address string, maxTries *int64) ([]*chainhash.Hash, error) {
